...
<h2 align="center">A Cross-Morphology Imitation Learning Framework for Bimanual Manipulation</h2>
...
<div align="center">
  <img src="assets/preprocessed_human_data.gif" width="40%" alt="Preprocessed human data demo">
</div>
...
```bash
python scripts/preprocess_human_data.py
```
